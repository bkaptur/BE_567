...
AGO3_block_mat = []; %number of AGO3 that are inhibited
...
mu_elem = 0.003; %rate of transcription active max element
...
k_load_AGO3_cleaved = 0.001; %rate of loading onto AGO3
...
k_block_AGO3_parsed = 0.000001; %rate of blocking AGO3
...
tau_load_AGO3 = -(1/(k_load_AGO3_cleaved*cleaved*AGO3))*log(r(10)); %load AGO3 with cleaved Max element
...
tau_block_AGO3 = -(1/(k_block_AGO3_parsed*parsed*AGO3))*log(r(13)); %load AGO3 with cleaved Max element

tau_min = min([tau_T_clust tau_T_elem tau_deg_clust tau_deg_elem tau_parse tau_deg_parsed tau_load_Aub tau_load_Piwi tau_slicer_cleave_AGO3 tau_load_AGO3 tau_slicer_cleave_Aub tau_deg_cleaved tau_block_AGO3]);
...
elseif (tau_min == tau_deg_cleaved)
    cleaved = cleaved - 1;
elseif (tau_min == tau_block_AGO3)
    AGO3 = AGO3 - 1;
    AGO3_block = AGO3_block + 1;
end
...
cleaved_mat = [cleaved_mat cleaved];
AGO3_block_mat = [AGO3_block_mat AGO3_block];
